                ...
                {filteredUsers.map((user) => (
                  <tr key={user.id} className="hover:bg-slate-50 transition">
                    ...
                    <td className="p-4 text-right pr-6 whitespace-nowrap">
                      <button onClick={() => openEditModal(user)} className="p-2 text-slate-400 hover:text-blue-600 transition"><Edit size={16} /></button>
                      <button onClick={() => handleDelete(user)} className="p-2 text-slate-400 hover:text-red-600 transition"><Trash2 size={16} /></button>
                    </td>
                  </tr>
                ))}
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
              ...
              <div className="p-4 sm:p-5 border-t border-slate-100 flex flex-col-reverse sm:flex-row justify-end gap-3 bg-slate-50 shrink-0">
                <button type="button" onClick={() => setIsModalOpen(false)} className="px-4 py-2.5 sm:py-2 rounded-xl border border-slate-200 sm:border-transparent text-slate-600 hover:bg-slate-200 transition text-sm font-medium w-full sm:w-auto text-center">ยกเลิก</button>
