...
const ShareModal = ({ isShareModalOpen, setIsShareModalOpen, handleShare, t }) => {
  ...
  return (
    <Transition show={isShareModalOpen} as={Fragment}>
      <Dialog as="div" className="relative z-[150]" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-6 text-center sm:p-4">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-[32px] bg-white text-left shadow-2xl transition-all w-full max-w-[420px] max-h-[90vh] flex flex-col border border-slate-200">
                {/* Header */}
                <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/30 shrink-0">
                  <div className="flex items-center gap-3">
                    ...
                    <Dialog.Title as="h3" className="font-black text-slate-800 uppercase tracking-widest text-[11px]">
