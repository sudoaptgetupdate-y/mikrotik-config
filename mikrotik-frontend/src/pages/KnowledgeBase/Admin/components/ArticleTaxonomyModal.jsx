          ...
          <Dialog as="div" className="relative z-[60]" onClose={() => setIsCategoryModalOpen(false)}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                >
                  <Dialog.Panel className="relative transform overflow-hidden rounded-3xl bg-white text-left shadow-2xl transition-all sm:my-8 w-full max-w-sm flex flex-col">
                    <div className="px-6 py-4 border-b border-slate-50 flex items-center justify-between bg-slate-50 shrink-0">
                      <Dialog.Title as="h3" className="font-bold text-slate-800 flex items-center gap-2 text-sm">
                    ...
                    <form onSubmit={handleCategorySubmit} className="p-6 space-y-4 bg-white overflow-y-auto">
