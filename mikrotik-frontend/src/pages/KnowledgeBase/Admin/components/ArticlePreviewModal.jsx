      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-[40px] bg-white text-left shadow-2xl transition-all sm:my-8 w-full max-w-5xl flex flex-col max-h-[90vh]">
                ...
                <div className="flex justify-between items-center p-5 sm:p-6 border-b border-slate-100 bg-white">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <Dialog.Title as="h3" className="font-black text-lg text-slate-800 tracking-tight leading-none">
