...
const defaultSettings = [
  ...
  { key: 'AI_ENABLED', value: JSON.stringify('false'), description: 'Enable or disable AI Assistant (Gemini)' },
  { key: 'AI_GEMINI_KEY', value: JSON.stringify(''), description: 'Google Gemini API Key' },
  { key: 'AI_SYSTEM_PROMPT', value: JSON.stringify('คุณคือ AI Monitoring Assistant ของ NT (National Telecom) หน้าที่ของคุณคือตอบคำถามเกี่ยวกับสถานะอุปกรณ์ในเครือข่าย โดยใช้ข้อมูลที่ได้รับให้เกิดประโยชน์สูงสุด ตอบเป็นภาษาไทยที่กระชับ สุภาพ และเป็นกันเอง ยึดข้อมูลในส่วนสถานะระบบเป็นหลักเสมอ') }
];
